...
class PilotageDueWarningsGeneratorTest {
    ...
    public static void beforeClass() throws IOException {
        ...
        calendar = mapper.readValue(new File("src/main/resources/holidayCalendar.json"), HolidayCalendar.class);
    ...
    void testReturnsArrivalAndDepartureWarning() {
        ...
        BigDecimal expected = tariff.getIncreaseCoefficientsByWarningType().get(HOLIDAY).multiply(BigDecimal.valueOf(2));

        BigDecimal result = warnings
                .stream()
