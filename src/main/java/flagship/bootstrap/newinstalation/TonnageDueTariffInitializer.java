...
import static flagship.domain.cases.entities.Ship.ShipType.*;
...
public class TonnageDueTariffInitializer {
  ...
  public static TonnageDueTariff getTariff() {
    ...
    final Map<Case.CallPurpose, Due> tonnageDuesByCallPurpose = new EnumMap<>(Case.CallPurpose.class);
    ...
    final Set<Ship.ShipType> shipTypesNotEligibleForDiscount = EnumSet.of(RECREATIONAL, NAVY, WORK_SHIP);
