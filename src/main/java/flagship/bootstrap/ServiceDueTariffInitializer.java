...
public class ServiceDueTariffInitializer {
    ...
    private static void initializePilotageDueTariff(PilotageDueTariff pilotageDueTariff) {
        ...
        Map<PilotageArea, Map<BigDecimal, Integer[]>> bourgasAreaPilotageFees = new EnumMap<>(PilotageArea.class);
        ...
        pilotageDueTariff.setIncreaseCoefficientsByCargoType(Collections.unmodifiableMap(increaseCoefficientByCargoType));
